...
public interface MemberDeckPortShipMappingMapper {
    ...
    int addShipToDeckPortShipMapping(@Param("member_id") String member_id, @Param("deck_id") int deck_id, @Param("member_ship_id") long member_ship_id);
    ...
    int clearDeckPortShipMapping(@Param("member_id") String member_id, @Param("deck_id") int deck_id);
}
