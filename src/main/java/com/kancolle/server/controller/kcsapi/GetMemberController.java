...
public class GetMemberController {
    ...
    public APIResponse<RequireInfo> requireInfo(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<Member> basic(@ModelAttribute(MEMBER_ID) long member_id) {
        Member api_data = memberService.getBasic(member_id);
        return new APIResponse<Member>().setApi_data(api_data);
    }

    @RequestMapping("/furniture")
    public APIResponse<List<MemberFurniture>> furniture(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<List<MemberKdock>> kdock(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<List<MemberNdock>> ndock(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    @RequestMapping("/deck")
    public APIResponse<List<MemberDeckPort>> deck(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<List<MemberMission>> mission(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<MemberRecord> record(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<List<MemberSlotItem>> slot_item(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<Map<String, Object>> unsetslot(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<List<MemberUseItem>> useitem(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<List<Object>> payitem(@ModelAttribute(MEMBER_ID) long member_id) {
        return new APIResponse<List<Object>>();
    }

    @RequestMapping("/picture_book")
    public APIResponse<ShipPictureBookResult> pictureBook(@ModelAttribute(MEMBER_ID) long member_id, @Validated PictureBookForm form, BindingResult result) {
    ...
    public APIResponse<List<MemberShip>> ship2(@ModelAttribute(MEMBER_ID) long member_id, @Validated Ship2Form form, BindingResult result) {
        checkArgument(!result.hasErrors());
    ...
    public APIResponse<Ship3Result> ship3(@ModelAttribute(MEMBER_ID) long member_id, @Validated Ship3Form form, BindingResult result) {
        checkArgument(!result.hasErrors());
    ...
    public APIResponse<List<MemberMaterialDto>> material(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<MemberDutyPageList> dutyList(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam("api_page_no") int pageNum) {
    ...
    public APIResponse<List<MemberMapCell>> mapcell(@ModelAttribute(MEMBER_ID) long member_id, @Validated MapCellForm form, BindingResult result) {
        checkArgument(!result.hasErrors());
    ...
    public APIResponse<ShipDeckResult> shipDeck(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam("api_deck_rid") int deckPortId) {
    ...
    public APIResponse<PresetDeckResponse> presetDeck(@ModelAttribute(MEMBER_ID) long member_id) {
