...
public class ReqMapController {
    ...
    public APIResponse<MapStartResult> start(@ModelAttribute(MEMBER_ID) long member_id, @Validated MapStartForm form, BindingResult result) {
    ...
    @RequestMapping("/next")
    public APIResponse<MapNextResult> next(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam(value = "api_recovery_type", defaultValue = "0") int recoverType)  {
