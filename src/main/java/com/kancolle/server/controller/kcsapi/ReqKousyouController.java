...
public class ReqKousyouController {
    ...
    public APIResponse<MemberKdock> createShip(@ModelAttribute(MEMBER_ID) long member_id, @Validated CreateShipForm form, BindingResult result) {
    ...
    public APIResponse<Object> speedUp(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam(value = "api_highspeed", required = true) boolean speedUp, @RequestParam(value = "api_kdock_id", required = true) Integer kdock_id) {
        memberKdockService.speedUp(member_id, kdock_id);
        return new APIResponse<>();
    }

    @RequestMapping("/getship")
    public APIResponse<GetShipResult> getShip(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam(value = "api_kdock_id", required = true) Integer kdock_id) {
    ...
    public APIResponse<MemberResourceResult> destroyShip(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam(value = "api_ship_id", required = true) Long member_ship_id) {
    ...
    public APIResponse<CreateItemResult> createItem(@ModelAttribute(MEMBER_ID) long member_id, @Validated CreateItemForm form, BindingResult result) {
        checkArgument(!result.hasErrors());
    ...
    public APIResponse<MemberSlotItemDestoryResult> destroyitem2(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam(value = "api_slotitem_ids", required = true) List<Long> slotitem_ids) {
