...
public class ReqFurnitureController {
    ...
    @RequestMapping("/buy")
    public APIResponse<Object> buy(@ModelAttribute(MEMBER_ID) long member_id, @Validated FurnitureBuyForm form, BindingResult result) {
    ...
    public APIResponse<Object> change(@ModelAttribute(MEMBER_ID) long member_id, @Validated FurnitureChangeForm form, BindingResult result) {
        checkArgument(!result.hasErrors());
    ...
    public APIResponse<List<FurnitureBGM>> musicList(@ModelAttribute(MEMBER_ID) long member_id) {
    ...
    public APIResponse<FurnitureCoinResult> musicPlay(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam(value = "api_music_id", required = true) String music_id) {
    ...
    public APIResponse<Object> setPortBGM(@ModelAttribute(MEMBER_ID) long member_id, @RequestParam(value = "api_music_id", required = true) int music_id) {
