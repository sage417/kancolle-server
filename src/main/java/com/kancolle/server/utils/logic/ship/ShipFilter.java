...
public abstract class ShipFilter {
     ...
     * 过滤出潜艇
     */
    public final static Predicate<IShip> ssFilter = ship -> {
     ...
     * 过滤出反潜船
     */
    public final static Predicate<IShip> antiSSShipFilter = ship -> {
        int shipType = ship.getShip().getShipTypeId();
    ...
    public final static Predicate<IShip> BBShipFilter = ship -> {
        int shipType = ship.getShip().getShipTypeId();
